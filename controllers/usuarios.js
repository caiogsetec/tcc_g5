...
module.exports = {
    async listarUsuarios(request, response) {
        try {
            const sql = 'SELECT usu_id, usu_nome, usu_email, usu_senha, usu_cpf, usu_telefone, usu_aceite_termos, usu_aceite_politicas, usu_funcionario = 1 as usu_funcionario FROM usuarios;';
        ...
        async cadastrarUsuarios(request, response) {
            try {
                ...
                const sql = 'INSERT INTO usuario (usu_id, usu_nome, usu_email, usu_senha, usu_cpf, usu_telefone, usu_aceite_termos, usu_aceite_politicas, usu_funcionario = 1 as usu_funcionarios FROM usuarios) VALUES (?, ?, ?, ?, ?,);';
        ...
        async editarUsuarios(request, response) {
            try {
                ...
                const sql = 'UPDATE usuarios SET usu_nome = ?, usu_email = ?, usu_senha = ?, usu_cpf = ?, usu_telefone = ?, usu_aceite_termos = ?, usu_aceite_politicas = ?, usu_funcionario = ?     WHERE usu_id = ?;'
